...
plot '2orderCD_FDM.dat' using 3:5  pt 0 ps 1.5 lc 'green' title sprintf('2orderCD_FDM (slope = %.2f)', 1.92982), \
     f(x) with lines lw 2 lc 'green' title sprintf('2orderCD_FDM linear (slope = %.2f)', 1.92982), \
