...
plot '2orderCD_FVM.dat' using 3:5  pt 14 ps 1.5 lc 'orange' title sprintf('2orderCD_FVM (slope = %.2f)', 1.9841), \
     f(x) with lines lw 2 lc 'orange' title sprintf('2orderCD_FVM linear (slope = %.2f)', 1.9841), \
